...
/**
 Base class for all sample_project views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the sample_project view hierarchy (such as wrapped iOS UIViews) was touched.

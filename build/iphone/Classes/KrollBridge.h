...
@interface sample_projectObject : KrollCoverageObject {
#else
@interface sample_projectObject : KrollObject {
#endif
@private
...
extern NSString * sample_project$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	sample_projectObject *_sample_project;
    KrollObject* console;
	BOOL shutdown;

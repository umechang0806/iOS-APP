 ...
 * Copyright (c) 2009-2011 by sample_project, Inc. All Rights Reserved.
...
//@interface sample_projectObject : NSObject
//@end

@interface sample_projectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[sample_projectObject class]])
		{
			for (NSString *key in [[(sample_projectObject*)o modules] allKeys])
			{

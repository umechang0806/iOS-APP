...
static NSString * const ksample_projectJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_sample_projectInjection
{
	...
	[html appendString:ksample_projectJavascript];
...
{
	// attempt to make well-formed HTML and inject in our sample_project bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _sample_projectInjection]];

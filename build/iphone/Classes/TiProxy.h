...
//Rare exceptions to indicate a bug in the _sample_project code (Eg, function that a subclass should have implemented)
...
/**
 The base class for sample_project proxies.
 */

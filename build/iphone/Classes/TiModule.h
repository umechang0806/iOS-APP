...
/**
 The base class for all sample_project modules
 */
...
/**
 sample_project Platform calls this method on startup.
 */
-(void)startup;

/**
 sample_project Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 sample_project Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 sample_project Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 sample_project Platform calls this method on resume.
 @param sender The sender of the event.
 */

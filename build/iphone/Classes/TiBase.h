...
// in simulator we redefine to format for sample_project Developer console
...
{\
	NSString * exceptionName = [@"org.sample_project." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.sample_project";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIsample_projectNativeItemNone = -1, 
	UIsample_projectNativeItemSpinner = -2,
	UIsample_projectNativeItemProgressBar = -3,
	
	UIsample_projectNativeItemSlider = -4,
	UIsample_projectNativeItemSwitch = -5,
	UIsample_projectNativeItemMultiButton = -6,
	UIsample_projectNativeItemSegmented = -7,
	
	UIsample_projectNativeItemTextView = -8,
	UIsample_projectNativeItemTextField = -9,
	UIsample_projectNativeItemSearchBar = -10,
	
	UIsample_projectNativeItemPicker = -11,
	UIsample_projectNativeItemDatePicker = -12,
	
	UIsample_projectNativeItemInfoLight = -13,
	UIsample_projectNativeItemInfoDark = -14,
	
	UIsample_projectNativeItemDisclosure = -15,
	
	UIsample_projectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all sample_project instances of
